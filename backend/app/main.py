...
from app.routes import auth_routes, patients, vitals, medications, messages, tasks, staff_config, audit_logs, emergencies
...
EXPORT_TABLE_ORDER = [
    ...
    "medications", "messages", "tasks", "emergency_escalations", "audit_logs",
]
...
def export_seed():
    ...
    lines = [
        ...
        "",
        "TRUNCATE audit_logs, emergency_escalations, messages, medications, vitals, tasks, patients, users, hospital_config CASCADE;",
        "",
    ]
    try:
